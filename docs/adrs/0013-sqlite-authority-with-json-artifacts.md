...
Implementation and crash-injection acceptance are tracked by [issue #7](https://github.com/feniix/prime-dispatch-prototype/issues/7). Until that lands, Beta Milestone 1 continues to use the superseded JSON authority and retains its documented crash limitations.
